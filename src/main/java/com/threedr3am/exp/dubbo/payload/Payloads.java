...
public enum Payloads {
  ...
  CommonsCollections1("CommonsCollections1", 1, new CommonsCollections1(), "arg[0]=cmd", "java", "commons-collections:commons-collections:3.1", CheckParams.CMD),
...
//  CommonsCollections4("CommonsCollections4", 1, new CommonsCollections4(), "arg[0]=cmd", "java", "commons-collections:commons-collections:3.1", CheckParams.CMD),
  CommonsCollections5("CommonsCollections5", 1, new CommonsCollections5(), "arg[0]=cmd", "java", "commons-collections:commons-collections:3.1", CheckParams.CMD),
  ...
  CommonsCollections6("CommonsCollections6", 1, new CommonsCollections6(), "arg[0]=cmd", "java", "commons-collections:commons-collections:3.1", CheckParams.CMD),
  ...
  CommonsCollections7("CommonsCollections7", 1, new CommonsCollections7(), "arg[0]=cmd", "java", "commons-collections:commons-collections:3.1", CheckParams.CMD),
  ...
  CommonsCollections9("CommonsCollections9", 1, new CommonsCollections9(), "arg[0]=cmd", "java", "commons-collections:commons-collections:3.1", CheckParams.CMD),
  CommonsCollections10("CommonsCollections10", 1, new CommonsCollections10(), "arg[0]=cmd", "java", "commons-collections:commons-collections:3.1", CheckParams.CMD),
